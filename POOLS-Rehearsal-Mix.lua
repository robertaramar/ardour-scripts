...
function factory(params)
	...
	return function()
		...
		local dialog_options = {
			{
				...
				path = "/home/rschneid/tmp/POOLS/USBMTK/Comfortably Numb 1"
			},
		...
		local pools_tracks = {
			...
			{name = "Vox Sasa", vox = "voxSasa", wave_files = {"TRK01.WAV"}, template = "", group = "vox"},
			...
			{name = "Overheads-L", vox = "", wave_files = {"TRK11.WAV"}, template = "POOLS Drum Overheads-L", group = "drums"},
			{name = "Overheads-R", vox = "", wave_files = {"TRK12.WAV"}, template = "POOLS Drum Overheads-R", group = "drums"},
		...
		for i = 1, #pools_tracks do -- #pools_tracks
			...
			if (template_name == "") then
				...
				if (voxmode == 1) then
					template_name = "POOLS Lead Vocals"
				end
				if (voxmode == 2) then
