...
function factory(params)
	...
	return function()
		...
		local pools_tracks = {
			...
			{name = "Vox Caro", vox = "voxCaro", wave_files = {"TRK01.WAV"}, template = "", group = "vox"},
			...
			{name = "Vox Michael", vox = "voxMichael", wave_files = {"TRK04.WAV"}, template = "", group = "vox"},
		...
		--	{name = "e-Drums", vox = "", wave_files = {"TRK15.WAV"}, template = "POOLS e-Drums", group = "drums"},
			{name = "Drums Left", vox = "", wave_files = {"TRK11.WAV"}, template = "POOLS Drum Overheads-L", group = "drums"},
			{name = "Drums Right", vox = "", wave_files = {"TRK12.WAV"}, template = "POOLS Drum Overheads-R", group = "drums"},
			{name = "Click Left", vox = "", wave_files = {"TRK15.WAV"}, template = "POOLS Keyboard-L", group = "drums"},
			{name = "Click Right", vox = "", wave_files = {"TRK16.WAV"}, template = "POOLS Keyboard-R", group = "drums"}
		}
		...
		for i = 1, #pools_tracks do -- #pools_tracks
			...
			if string.sub(pools_tracks[i]["name"], 1, 5) == "Click" and not rv["click"] then
				template_name = ""
			end
